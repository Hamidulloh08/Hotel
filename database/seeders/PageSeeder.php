        ...
        $pages = [
            [
                ...
                'content'  =>
                    ...
                    Html::tag('div', '[rooms-introduction title="Our rooms" description="Each of the 22 beautiful guest rooms sleeps up to 6 and includes a private bathroom, Wi-Fi, cable TV, and a full morning breakfast includes." background_image="general/004.jpg" first_image="general/01.jpg" second_image="general/02.jpg" third_image="general/03.jpg" button_text="Take a tour" button_url="/rooms"][/rooms-introduction]') .
